...
The active source-and-image refresh is tracked in the [post-domain candidate publication task](docs/planning/post-domain-candidate-publication-refresh-task.md).
